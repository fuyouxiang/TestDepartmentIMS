 ...
 */
public class UpdateBuMenServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateBuMenServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(type.equals("select")) {
			System.out.println(timelog+"部门查询————————");
			
			String sql = "select B_USER,B_NAME,PHONE,EMAIL,B_CENTER from sys_bumen";
			...
			request.getRequestDispatcher("guanliyuan/BuMen.jsp").forward(request, response);
		}
		
		else if (type.equals("add")){
			
			System.out.println(timelog+"部门添加————————");
			
			String W_NAME = request.getParameter("W_NAME");//微服务名称
			System.out.println(timelog+"部门名称:"+W_NAME);
