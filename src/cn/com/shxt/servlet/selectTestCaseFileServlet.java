...
public class selectTestCaseFileServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println(time+"查询测试用例文件列表servlet==========================");
		HttpSession session = request.getSession();
	    String name=(String) session.getAttribute("username");
		String sql2 = "select * from SYS_USER where U_NAME='"+name+"' and YONGLI='1'";
		...
		String sql = "select ATTACH_ID,ATTACH_NAME,ITEM_TYPE,ATTACH_TYPE,REMARK,CREATE_TIME,APPID,ATTACH_PATH,TC_RESULT from SYS_ATTACH_FILE where APPID='003' and FILE_CATALOG='"+FILE_CATALOG+"'order by CREATE_TIME desc";
