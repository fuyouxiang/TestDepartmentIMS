...
public class selectItemFileServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println(time+"查询项目文件列表servlet==========================");
		...
		String sql = "select ATTACH_ID,ATTACH_NAME,ATTACH_TYPE,REMARK,CREATE_TIME,APPID,ATTACH_PATH from SYS_ATTACH_FILE where APPID='002' and FILE_CATALOG='"+FILE_CATALOG+"' order by CREATE_TIME desc";
		/*int iRows = 5;
		int nowPage = 1;
