...
public class selectNewPersonFileServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println(time+"查询新人必读文件列表servlet===============");
		HttpSession session = request.getSession();
	    String name=(String) session.getAttribute("username");
		String sql2 = "select * from SYS_USER where U_NAME='"+name+"' and XINREN='1'";
	    ...
	    if(flag>0){
			...
			String sql = "select ATTACH_ID,ATTACH_NAME,ITEM_TYPE,ATTACH_TYPE,REMARK,CREATE_TIME,APPID,ATTACH_PATH from SYS_ATTACH_FILE where APPID='001' and FILE_CATALOG='"+FILE_CATALOG+"' order by CREATE_TIME desc";
			/*int iRows = 5;
			int nowPage = 1;
