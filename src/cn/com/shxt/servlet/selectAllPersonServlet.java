...
public class selectAllPersonServlet extends HttpServlet {
	
	private static final long serialVersionUID = -8389477181739650374L;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("resource/listAllperson.jsp").forward(request, response);
	}
