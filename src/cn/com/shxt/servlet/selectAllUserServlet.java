...
public class selectAllUserServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String sql = "select u_id,u_name,u_password,u_state,u_role from sys_user  where u_role != '文档'";
		/*int iRows = 5;
		int nowPage = 1;
		...
		request.getRequestDispatcher("guanliyuan/listAlluser.jsp").forward(request, response);
	}
