...
public class selectAllFileServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String sql = "select ATTACH_ID,ATTACH_NAME,ATTACH_TYPE,ITEM_TYPE,REMARK,CREATE_TIME,APPID,ATTACH_PATH,FILE_CATALOG from SYS_ATTACH_FILE order by CREATE_TIME desc";
