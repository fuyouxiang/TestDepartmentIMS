...
public class selectAllTestServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//String sql1 = "select t_id,t_name,t_case,t_document,t_bug,t_year from sys_test order by t_name";
		...
		request.getRequestDispatcher("resource/listAlltest.jsp").forward(request, response);
	}
