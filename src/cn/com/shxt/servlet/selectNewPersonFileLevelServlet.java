...
public class selectNewPersonFileLevelServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String sql = "SELECT FILE_CATALOG,COUNT(*) FROM SYS_ATTACH_FILE  WHERE APPID='001' GROUP BY FILE_CATALOG";
		...
		request.getRequestDispatcher("youzhishi/NewPersonLevel_Phone.jsp").forward(request, response);
	    }else{
