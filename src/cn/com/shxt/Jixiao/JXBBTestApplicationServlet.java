...
public class JXBBTestApplicationServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println(timelog+"绩效系统版本测试申请单接口——————————");
		
		
		String OldBumenAndBoss = request.getParameter("bumen");
		System.out.println("部门(未转码)："+OldBumenAndBoss);

		String sql= "select B_NAME from SYS_BUMEN where B_CENTER='预算绩效产品部'";
     ...
     */
		...
		request.getRequestDispatcher("JixiaoTest/TestFormSubmit_banben.jsp").forward(request, response);
	}
