...
<form action="<%=path %>/selectLeaveServlet2"  name="MyPageForm" method="post"  id="pageForm" onsubmit="return submitMyForm()">
	   ...
	   <!--  <input name="YEAR"  id="YEAR" type="text" class="text" style="width:154px" value="<%=session.getAttribute("YEAR") %>"/>
	    <input name="MONTH"  id="MONTH" type="text" class="text" style="width:154px" value="<%=session.getAttribute("MONTH") %>" /> -->
...
<% 
 ...
 %> 
			  ...
			  <td width="144" align="left"><button style="font-size:15px;font-weight:bold;width:100px"  onclick="tableToExcel('tableAll','<%=session.getAttribute("MONTH") %>月请假情况表');">导出当前月</button></td>	
