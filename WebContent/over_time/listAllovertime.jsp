...
<form action="<%=path %>/selectOvertimeServlet"  name="MyPageForm" method="post"  id="pageForm" >
...
<% 
 ...
 %> 
			  ...
			  <td align="right"><input style="font-size:15px;font-weight:bold;width:80px" size="12" type="button" value="分页显示" onclick="window.location.href='<%=path %>/selectOvertimeServlet'"></td>
			  <!-- <td width="144" align="left"><button style="font-size:15px;font-weight:bold;width:80px"  onclick="javascript:exportToExcel('testList','');">导出全部</button></td>	 -->
		    	<td width="144" align="left"><button style="font-size:15px;font-weight:bold;width:80px"  onclick="tableToExcel('tableAll','全部加班情况表');">导出全部</button></td>
		    </tr>
          ...
          <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" id="tableAll">
              ...
              <tr>
				...
				<table id = "testList" width="100%" border="2" cellpadding="4" cellspacing="1" bgcolor="#EEEEEE" class="newfont03">
				 <tr class="CTitle" >
                    	<td id="div_title" height="22" colspan="7" align="center" style="font-size:16px">加班情况表</td>
                  </tr>
                  ...
                  <!-- <td height="40" class="bor_1"><input name='isBuy'  type="checkbox"  id="all"  onclick="checkAll(this.checked)"/></td> -->
                    ...
                    <td style="font-size:15px;font-weight:bold">加班月份</td>
                    <td style="font-size:15px;font-weight:bold">加班日期</td>
                    <td style="font-size:15px;font-weight:bold">加班工时(人/天)</td>
                    <td style="font-size:15px;font-weight:bold">加班事由</td>
                   ...
                   <tbody>
                        ...
                        <%
                          ...
                          <tr align="center">
                            ...
                            <td class="bor_2" style="font-size:15px;text-align:center;font-weight:bold"><%=stuMap.get("O_NAME") %></td>
                            <td class="bor_2" style="font-size:15px;text-align:center;font-weight:bold"><%=stuMap.get("O_MONTH") %>月</td>
                            <td class="bor_2" style="font-size:15px;text-align:center;font-weight:bold"><%=stuMap.get("O_DATE") %></td>
                            <td class="bor_2" style="font-size:15px;text-align:center;font-weight:bold"><%=stuMap.get("O_TIME") %>人/天</td>
                            <td class="bor_2" style="font-size:15px;text-align:center;font-weight:bold"><%=stuMap.get("O_HOLD1") %></td>
