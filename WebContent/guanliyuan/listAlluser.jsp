...
<form action="<%=path %>/selectUserServlet"  name="MyPageForm" method="post"  id="pageForm" >
          ...
          <td height="62" background="images/nav04.gif">
		   ...
		   <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		    <tr>
			  ...
			  <td width="538">
			  <input type="button" value="分页显示" onclick="window.location.href='<%=path %>/selectUserServlet'">
			  <!-- <button onclick="javascript:exportToExcel('testList','');">导出全部</button> -->
			  <button onclick="tableToExcel('tableAll','全部用户表');">导出全部</button>
			  <!--  
          ...
          <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" id="tableAll">
              ...
              <tr>
				...
				<table id = "testList" width="100%" border="2" cellpadding="4" cellspacing="1" bgcolor="#EEEEEE" class="newfont03">
				 <tr class="CTitle" >
                    	<td id="div_title" height="22" colspan="6" align="center" style="font-size:16px">所有用户列表</td>
                  </tr>
