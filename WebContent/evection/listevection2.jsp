...
<!-- 右侧滚动条 -->
<div style="overflow-x:hidden;overflow-y:scroll;width:100%;height:580px;">
<form action="<%=path %>/selectEvectionServlet2"  name="MyPageForm" method="post"  id="pageForm" >
...
<% 
 ...
 %> 
						...
						<select style="high:150;font-weight:bold;" name="MONTH"  id="MONTH">
					     <option style="font-size:13px;" value="<%=session.getAttribute("MONTH") %>"> &nbsp;&nbsp;<%=session.getAttribute("MONTH") %>&nbsp;&nbsp;</option>                                
