...
%>	
<body>
<form action="<%=path %>/selectItemFileServlet?FILE_CATALOG=<%=FILE_CATALOG %>"  name="MyPageForm" method="post"  id="pageForm" >
		...
		<div class="top_dingw">
			<div class="top_bg" id="top_bg">
				<div class="top_main">
            		...
            		<input type="button" value="返回" id="fp" style="font-size:15px;font-weight:bold" onclick="location.href='<%=path %>/selectItemFileLevelServlet'"/>
            		<input id="CHA_NAME" name="CHA_NAME" type="text" size="18"/>
            		<input type="hidden" id="CHA_APPID" name="CHA_APPID" value="002"type="text"/>
		            ...
		            <li>
		                <a href="youzhishi/DownloadPDF.jsp?ATTACH_PATH=<%=stuMap.get("ATTACH_PATH") %>&ATTACH_NAME=<%=stuMap.get("ATTACH_NAME") %>" target="_blank">
		                    ...
		                    <dl>
		                        ...
		                        <dd>关键词：<%=stuMap.get("ATTACH_TYPE") %></dd>
