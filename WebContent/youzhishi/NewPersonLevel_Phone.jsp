...
<body>
<form action="<%=path %>/selectNewPersonFileLevelServlet"  name="MyPageForm" method="post"  id="pageForm" >
		...
		<div class="shadow">
			<div class="zy_news">
              ...
              %>
		            ...
		            <li>
		                <a href="<%=path %>/selectNewPersonFileServlet?FILE_CATALOG=<%=stuMap.get("FILE_CATALOG") %>">
