...
<script type="text/JavaScript" src="<%=path %>/My97DatePicker/WdatePicker.js">
  ...
  <body class="ContentBody">
	...
	<form action="<%=path%>/AddFileServlet" method="post" id =formId  name="formname"  onsubmit="return submitMyForm()">
		...
		<div class="msg">当前位置：首页 >> 文档管理 >> 文件上传>> 文件信息填写>> 二级目录选择</div>
 
		<TR>
			<TD width="100%">
				<fieldset style="height:100%;">
				<legend>第三步：二级目录选择</legend>
	      <%
      ...
      %>
					  <table border="0" cellpadding="2" cellspacing="1" style="width:100%">
				       ...
				       <td>
				       <select style="width:500px;height:30px" name="APPID"  id="APPID">                               
					   <option style="font-size:25px;color:blue" value="001"> &nbsp;&nbsp;新人必读 &nbsp;&nbsp;</option>				     
					   <option style="font-size:25px;color:blue" value="002"> &nbsp;&nbsp;项目文档 &nbsp;&nbsp;</option>
					   <option style="font-size:25px;color:blue" value="003"> &nbsp;&nbsp;测试用例 &nbsp;&nbsp;</option>
					   <option style="font-size:25px;color:blue" value="004"> &nbsp;&nbsp;知识分享 &nbsp;&nbsp;</option>
				       ...
				       <td>
				       <select style="width:500px;height:30px" name="FILE_CATALOG"  id="FILE_CATALOG">                               
					   <option style="font-size:25px;color:blue" value="001"> &nbsp;&nbsp;新人必读 &nbsp;&nbsp;</option>				     
					   <option style="font-size:25px;color:blue" value="002"> &nbsp;&nbsp;项目文档 &nbsp;&nbsp;</option>
					   <option style="font-size:25px;color:blue" value="003"> &nbsp;&nbsp;测试用例 &nbsp;&nbsp;</option>
					   <option style="font-size:25px;color:blue" value="004"> &nbsp;&nbsp;知识分享 &nbsp;&nbsp;</option>
