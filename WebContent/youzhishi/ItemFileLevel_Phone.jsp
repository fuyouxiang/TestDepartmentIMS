...
<body>
<form action="<%=path %>/selectItemFileLevelServlet"  name="MyPageForm" method="post"  id="pageForm" >
		...
		<div class="shadow">
			<div class="zy_news">
              ...
              %>
		            ...
		            <li>
		                <a href="<%=path %>/selectItemFileServlet?FILE_CATALOG=<%=stuMap.get("FILE_CATALOG") %>">
