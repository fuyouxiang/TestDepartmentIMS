...
<form action="<%=path %>/selectItemFileServlet"  name="MyPageForm" method="post"  id="pageForm" >
          ...
          <td height="62" background="images/nav04.gif">
		   ...
		   <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <form action="<%=path %>/selectMoHuFileServlet" name="MyPageForm2" method="post"  id =formId2 id ="pageForm2">
            		关键词模糊查询：<%=aaa %><input style="width:150px" id="CHA_NAME" name="CHA_NAME" type="text" size="15"/>
