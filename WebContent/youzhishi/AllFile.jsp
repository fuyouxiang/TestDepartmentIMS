          ...
          <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
              ...
              <tr>
				...
				<table id = "testList" width="100%" border="2" cellpadding="4" cellspacing="1" bgcolor="#EEEEEE" class="newfont03">
				 <tr class="CTitle" >
                    	<td id="div_title" height="22" colspan="9" align="center" style="font-size:16px">文档列表</td>
                  </tr>
                        ...
                        <%
                          ...
                          <tr align="center">
							...
							<td class="bor_2 bor_4" style="font-size:15px;text-align:center;font-weight:bold"> 
							 ...
							 <a href="<%=path %>/updateFileLevelServlet?APPID=<%=stuMap.get("APPID") %>&ATTACH_NAME=<%=stuMap.get("ATTACH_NAME") %>&FILE_CATALOG=<%=stuMap.get("FILE_CATALOG") %>" >修改</a>
							...
							<span><img  src="<%=path %>/images/del.gif" width="16" height="16" onclick = "if(window.confirm('您确定要删除吗？')){window.location.href='DeleteFileServlet?ATTACH_ID=<%=stuMap.get("ATTACH_ID") %>&ATTACH_NAME=<%=stuMap.get("ATTACH_NAME") %>&ATTACH_TYPE=<%=stuMap.get("ATTACH_TYPE") %>'}"/>删除</span></td>
                        </tr>
