...
%>			
<body>
<form action="<%=path %>/selectNewShareFileServlet?FILE_CATALOG=<%=FILE_CATALOG %>"  name="MyPageForm" method="post"  id="pageForm" >
		...
		<div class="top_dingw">
			<div class="top_bg" id="top_bg">
				<div class="top_main">
            		...
            		<input type="button" value="返回" id="fp" style="font-size:15px;font-weight:bold" onclick="location.href='<%=path %>/selectNewShareFileLevelServlet'"/>
