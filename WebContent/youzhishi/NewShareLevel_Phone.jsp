...
<body>
<form action="<%=path %>/selectNewShareFileLevelServlet"  name="MyPageForm" method="post"  id="pageForm" >
		...
		<div class="shadow">
			<div class="zy_news">
              ...
              %>
		            ...
		            <li>
		                <a href="<%=path %>/selectNewShareFileServlet?FILE_CATALOG=<%=stuMap.get("FILE_CATALOG") %>">
