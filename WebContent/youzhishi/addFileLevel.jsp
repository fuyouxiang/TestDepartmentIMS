...
<script type="text/JavaScript" src="<%=path %>/My97DatePicker/WdatePicker.js">
  ...
  %>
	...
	<form action="<%=path%>/AddFileLevelServlet" method="post" id ="form1"  name="form1"  onsubmit="return submitMyForm()">
		...
		<div class="msg">当前位置：首页 >> 文档管理 >> 文件上传>> 文件信息填写>> 文件夹选择</div>
 
		<TR>
			<TD width="100%">
				<fieldset style="height:100%;">
				<legend>第三步：文件夹选择</legend>
					  ...
					  <table border="0" cellpadding="2" cellspacing="1" style="width:100%">
				       ...
				       <select name="FILE_CATALOG_choose" id="FILE_CATALOG1" style="width:500px;height:30px;color:blue;font-weight:bold;font-size:14px;">
				       <%
