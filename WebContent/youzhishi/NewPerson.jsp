...
<form action="<%=path %>/selectNewPersonFileServlet"  name="MyPageForm" method="post"  id="pageForm" >
                    	...
                    	<%
                          ...
                          <tr align="center">
							...
							<td class="bor_2 bor_4" style="font-size:15px;text-align:center;font-weight:bold"> 
							 ...
							 <a href="youzhishi/ShowPDF.jsp?ATTACH_PATH=<%=stuMap.get("ATTACH_PATH") %>" target="_blank">预览</a>
							<a href="youzhishi/DownloadPDF.jsp?ATTACH_PATH=<%=stuMap.get("ATTACH_PATH") %>&ATTACH_NAME=<%=stuMap.get("ATTACH_NAME") %>" target="_blank">下载</a>
