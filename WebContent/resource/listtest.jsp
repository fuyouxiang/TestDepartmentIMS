...
<form action="<%=path %>/selectTestServlet"  name="MyPageForm" method="post"  id="pageForm" >
...
<% 
 ...
 %> 
			 ...
			 <!--<td align="right"><input style="font-size:15px;font-weight:bold;width:80px" size="12" type="button" value="显示全部" onclick="window.location.href='<%=path %>/selectAllTestServlet'"></td> -->
		      ...
		      <td width="144" align="left"><button style="font-size:15px;font-weight:bold;width:100px"  onclick="tableToExcel('tableAll','全年测试情况统计');">导出全年</button></td>	
		    </tr>
				...
				<table id = "testList" width="100%" border="2" cellpadding="4" cellspacing="1" bgcolor="#EEEEEE" class="newfont03">
				 <tr class="CTitle" >
                  ...
                  <!-- <td height="40" class="bor_1"><input name='isBuy'  type="checkbox"  id="all"  onclick="checkAll(this.checked)"/></td> -->
                    ...
                    <td style="font-size:15px;font-weight:bold">总天数</td>
                    <td style="font-size:15px;font-weight:bold">总工时</td>
                    <td style="font-size:15px;font-weight:bold">总用例产出</td>
                    <td style="font-size:15px;font-weight:bold">总文档产出</td>
                    <td style="font-size:15px;font-weight:bold">总BUG产出</td>
                  </tr>
                   <tbody>
