...
<% 
 ...
 %> 
			 ...
			 <td align="right"><input style="font-size:15px;font-weight:bold;width:80px" size="12" type="button" value="分页显示" onclick="window.location.href='<%=path %>/selectPersonServlet2'"></td>
			  ...
			  <td width="144" align="left"><button style="font-size:15px;font-weight:bold;width:80px"  onclick="tableToExcel('tableAll','全年个人情况统计');">导出全部</button></td>
