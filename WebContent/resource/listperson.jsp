...
<% 
 ...
 %>
			 ...
			 <!--<td align="right"><input style="font-size:15px;font-weight:bold;width:80px" size="12" type="button" value="显示全部" onclick="window.location.href='<%=path %>/selectAllPersonServlet'"></td> -->
			  <!-- <td width="144" align="left"><button style="font-size:15px;font-weight:bold;width:100px"  onclick="javascript:exportToExcel('testList','');">导出当前页</button></td>	 -->
	 	      <td width="144" align="left"><button style="font-size:15px;font-weight:bold;width:100px"  onclick="tableToExcel('tableAll','全年个人情况统计');">导出全年</button></td>		
		    </tr>
