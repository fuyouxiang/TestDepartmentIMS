...
<form action="<%=path %>/selectPersonServlet2"  name="MyPageForm" method="post"  id="pageForm" >
          ...
          <td height="62" background="images/nav04.gif">
		   ...
		   <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		    ...
		    <td width="538"  align="left" style="font-size:15px">
			  <form action="selectPersonServlet" name="MyPageForm" method="post"  id =formId id ="pageForm" onsubmit="return submitMyForm()">
...
<% 
 ...
 %> 
            	...
            	<td width="144" align="left"><button style="font-size:15px;font-weight:bold;width:100px"  onclick="tableToExcel('tableAll','<%=session.getAttribute("MONTH") %>个人情况统计');">导出当前页</button></td>
		    </tr>
          ...
          <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" id="tableAll">
              <tr>
				...
				<table id = "testList" width="100%" border="2" cellpadding="4" cellspacing="1" bgcolor="#EEEEEE" class="newfont03">
				 <tr class="CTitle" >
                    	<td id="div_title" height="22" colspan="7" align="center" style="font-size:16px">所有用户列表</td>
                  </tr>
                  ...
                  <!--  <td height="40" class="bor_1"><input name='isBuy'  type="checkbox"  id="all"  onclick="checkAll(this.checked)"/></td>-->
                    ...
                    <td style="font-size:15px;font-weight:bold">年度</td>
                    <td style="font-size:15px;font-weight:bold"><%=session.getAttribute("MONTH") %>加班天数</td>
                    <td style="font-size:15px;font-weight:bold"><%=session.getAttribute("MONTH") %>出差天数</td>
                    <td style="font-size:15px;font-weight:bold"><%=session.getAttribute("MONTH") %>请假天数</td>
                  </tr>
                   <tbody>
                        ...
                        <%
                          ...
                          <tr align="center">
                            ...
                            <td class="bor_2" style="font-size:15px;text-align:center;font-weight:bold"><%=stuMap.get("P_NAME") %></td>
                            <td class="bor_2" style="font-size:15px;text-align:center;font-weight:bold"><%=stuMap.get("P_YEAR") %></td>
