        ...
        <tr>
          <td height="62" background="images/nav04.gif">
		   ...
		   <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <td align="right"><input style="font-size:15px;font-weight:bold;width:80px"  type="button" value="显示全部" onclick="window.location.href='<%=path %>/selectAllSignServlet'"></td>
