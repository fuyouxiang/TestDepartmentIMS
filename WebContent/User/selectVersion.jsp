...
<% 
 ...
 %>
			  ...
			  <td align="right"><input style="font-size:15px;font-weight:bold;width:80px" size="12" type="button" value="显示全部" onclick="window.location.href='<%=path %>/selectAllVersionServlet'"></td>
          ...
          <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" id="tableAll">
              ...
              <tr>
				...
				<table id = "testList" width="100%" height="100px" border="2" cellpadding="0" cellspacing="1" bgcolor="#EEEEEE" class="newfont03">
				 <tr class="CTitle" >
                    	<td id="div_title" height="28" colspan="13" align="center" style="font-size:14px">工作情况表</td>
                  </tr>
                  ...
                  <!--  <td height="40" class="bor_1"><input name='isBuy'  type="checkbox"  id="all"  onclick="checkAll(this.checked)"/></td>-->
                    ...
                    <td  style="font-size:13px;font-weight:bold">工时</td>
                   ...
                   <tbody>
                        ...
                        <%
                          ...
                          <tr align="center" style="">
                          	...
                          	<td  class="bor_2" style="font-size:13px;text-align:center;font-weight:bold;height:2px;line-height:38px;"> <%=i+1 %> </td>
                            ...
                            <td  width=450 class="bor_2" style="font-size:11px;text-align:center;"> <%=stuMap.get("V_WORK") %></td>
