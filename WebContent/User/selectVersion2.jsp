...
<form action="<%=path %>/selectVersionServlet2"  name="MyPageForm" method="post"  id="pageForm" >
...
<% 
 ...
 %> 
		      ...
		      <td width="144" align="left"><button style="font-size:15px;font-weight:bold;width:100px"  onclick="tableToExcel('tableAll','当前页日报情况表');">导出当前页</button></td>	
		    </tr>
                   ...
                   <tbody>
                        ...
                        <%
                          ...
                          <tr align="center">
							...
							<!-- <input name="Submit" type="submit"  value="修改"  onclick = "updateStu(<%=stuMap.get("V_ID") %>"/>  -->
